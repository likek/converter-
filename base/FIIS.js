...
function FIISForm(form) {
    ...
    var initField = function (self) {
        return function (ele) {
            ...
            self.requestData(ele, ele.getAttribute("field"), args);
        };
    } (this);
...
FIISForm.SingleValueConv = function () {
    window.forms.SingleValueConv.apply(this, arguments);
    this.DecodeArguments = function (ele, args) {
        return args[0].Result;
    }
}
FIISForm.ListValueConv = function () {
    window.forms.ListValueConv.apply(this, arguments);
    this.DecodeArguments = function (ele, args) {
        return args[0].Result;
    }
...
FIISForm.ListViewConv = function () {
    window.forms.ListViewConv.apply(this, arguments);
    this.DecodeArguments = function (ele, args) {
        return args[0].Result;
    }
}
FIISForm.DropDownListConv = function () {
    window.forms.DropDownListConv.apply(this, arguments);
    this.DecodeArguments = function (ele, args) {
        return args[0].Result;
    }
}
FIISForm.FilterableListConv = function () {
    window.forms.FilterableListConv.apply(this, arguments);
    this.DecodeArguments = function (ele, args) {
        return args[0].Result;
    }
}
FIISForm.TileListConv = function () {
